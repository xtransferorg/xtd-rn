...
export const varCreator = (TOKENS: TokensType) => {
  return {
    ...
    dropdown_background_color: TOKENS['--color-bg-1'],
    ...
    dropdown_text_margin_right: TOKENS['--spacing-1'],
    dropdown_text_icon_size: TOKENS['--font-size-3'],
    dropdown_text_icon_color: TOKENS['--color-text-6'],
