...
import { ImageSource, Image as XrnImage } from '@xrnjs/image';
import {
  ColorValue,
  ImageErrorEventData,
  ImageStyle,
...
const Image = (props: ImageProps) => {
  ...
  const { width: sWidth, height: sHeight } = (source as ImageSource) ?? {};
  ...
  return svg ? (
    ...
    <XrnImage
      source={source}
      tintColor={tintColor}
      style={StyleSheet.flatten([size as ImageStyle, fStyle]) as ImageStyle}
      onError={_onError}
      onLoad={onLoad}
      {...restProps}
    />
