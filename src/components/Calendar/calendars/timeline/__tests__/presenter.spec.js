...
describe('timeline presenter', () => {
  ...
  describe('buildTimeString', () => {
    ...
    it('should concatenate date when passed', () => {
      expect(uut.buildTimeString(10, 30, '2022-12-23')).toBe(
        '2022-12-23 10:30:00'
      );
      expect(uut.buildTimeString(15, 0, '2017-03-05')).toBe(
        '2017-03-05 15:00:00'
      );
    });
  });
  ...
  describe('calcTimeOffset', () => {
    ...
    it.skip('should give offset based on current time', () => {
      jest
        .useFakeTimers()
        .setSystemTime(new Date('2020-01-01 15:30').getTime());
      expect(uut.calcTimeOffset(100)).toBe(1550);

      jest
        .useFakeTimers()
        .setSystemTime(new Date('2020-01-01 12:10').getTime());
